...
#						icon = "error",
#						handler=hgmessage)		
			funout(paste(gettext("Problem during the test, the ODBC link works but doesn't point to the database 0.5, check the ODBC link",domain="R-stacomiR"),
								"\n",
								gettext("ODBC link",domain="R-stacomiR"),
								" :",
								baseODBC[1],
...
#				}
			...
			funout(paste(gettext("Problem when testing the ODBC connection",domain="R-stacomiR"),
							"\n",
							gettext("ODBC link",domain="R-stacomiR"),
							" :",
							baseODBC[1],
...
#' 
#' @export
stacomi=function(gr_interface=FALSE,login_window=FALSE,database_expected=TRUE){
	...
	if (gr_interface) stop("Impending the development of shiny app, this option is no longer supported in version 0.6") 
	if (login_window) stop("Impending the development of shiny app, this option is no longer supported in version 0.6") 
